...
const IndexPage = () => (
  <Layout>
    ...
    <p>
      ...
      Edward Neverdiet's <a href='' class='rick'>supple</a> fingers
    ...
    <p>
      ...
      tension between Don Knotts and Suzanne Somers. He must decode the conspiracy.
      It was then he became inspired to make good on his 1991 New Year Resolution
      to "execute a workout routine". The sticky note was still there on the dusty
      tape marked: Wholesome Animal Sounds and Suggestive Exercise Commercials.
    </p>
    <p>
      "I dub it Project Thick Thighs!" he celebrated then proceeded to
      parsimoniously mimic, into a mirror, the salacious thigh squeezing movements
      of the Thighmaster Toning System. "Practice makes perfect," he chuckled,
      camera in hand, Catrick pacing in and out of the field of view. He later
      marked this tape: Patriot Thighs That Will Make America Great Again.
      Catrick was a Siamese at the time.
    </p>
    <p>
      Since project launch, Edward has, "been removed from the gym at least three
      times," Jenny commented to Austen, the head bro at Planet Fitness. She
      slapped him playfully and with a toothy grin she continued, "Why do you keep
      letting him in here?" It's the kind of toothy grin that implies sex in a
      public bathroom.
    </p>
    <p>
      Austen flexed his bicep and imagined a steaming plate of corned beef hash,
    ...
    <p>
      Vigorously massaging his thighs, Edward retorts, "I am sore from my workout.
      I did three sets of," he thinks of an amount of weight that might impress
      Snitch, "five hundred pounds."
    </p>
    <p>
      "Wow sire, I'm­—"
    </p>
    ...
    <p>
      ...
      off the planet at night if that was so."
    </p>
    <p>
      "But great he-who-shall-be-obeyed!", cries Snitch. "I only do your bidding
      ever since you saved me from myself that time when I almost did that thing."
    </p>
    <p>
    ...
    <p>
      ...
      Snitch. I've got to stop hiring these discount cronies off Craigslist, he
      thinks. <em>I tasked him to uncover the truth of the prophecy and he comes back
        to me with the earth is rou­—</em>
    </p>
    <p>
      Sudden realization pierces the King like an arrow through the heart.
      Clutching his chest, he drops Catrick who lets out a shrill "mrrrow" in
      protest. His face transitions from shock to fear to utter fury.
    </p>
    <p>
    ...
    <div class='nextWeek'>
      ...
      <ul>
        <li class='nextWeek'><a href='' class='nate'>banana ketchup</a></li>
        <li class='nextWeek'><a href='' class='grimes'>galvanize</a></li>
        <li class='nextWeek'><a href='' class='josh'>flaccid</a></li>
        <li class='nextWeek'><a href='' class='victoria'>nihilism</a></li>
        <li class='nextWeek'><a href='' class='rick'>chafing dish</a></li>
      </ul>
    </div>
  </Layout>
)
